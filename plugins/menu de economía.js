...
├⇶🧮⃟⟫_${usedPrefix}top_
├⇶⚖️⃟⟫_${usedPrefix}levelup_
├⇶💸⃟⟫_${usedPrefix}myns_
├⇶👑⃟⟫⃟_${usedPrefix}perfil_
├⇶💰⃟⟫_${usedPrefix}work_
├⇶🧮⃟⟫_${usedPrefix}minar_
├⇶⚖️⃟⟫_${usedPrefix}buy_
...
╰━━━━━✯𓆩ֶ፝֟𓆪⁩✯━━━━━╯
`.trim()
conn.sendHydrated(m.chat, str, wm, pp,  '', '💖𝐆𝐫𝐮𝐩𝐨 𝐝𝐞 𝐟𝐚𝐜𝐞𝐛𝐨𝐨𝐤💖', null, null, [
['', '/donar'],
['🌹⃟🏰𝑴𝑬𝑵𝑼 𝑫𝑬 𝑹𝑨𝑵𝑩𝑶𝑴🌹⃟🏩', '/menuranbom'],
['👩‍💻️⃟ᬽ𝑪𝑯𝑨𝑻 𝑨𝑵𝑶𝑵𝑰𝑴𝑶👻️⃟ᬽ', '/menuanonimo'],
...
handler.tags = ['main']
handler.command = /^(Menueconomía|menueconomía\?)$/i
handler.exp = 50
handler.fail = null
